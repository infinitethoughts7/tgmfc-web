      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative h-12 w-12">
            <Image
              src="/logos/telangana.png" // replace with actual logo path
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-gray-300 pl-4">
            ...
            <button
              ...
              className="flex items-center gap-1 rounded p-1 hover:bg-green-100"
            ...
            <button
              ...
              className={`rounded p-1 hover:bg-green-100 ${isScreenReaderActive ? 'bg-green-200' : ''}`}
              aria-label={isScreenReaderActive ? "Disable screen reader" : "Enable screen reader"}
              title={isScreenReaderActive ? "Disable screen reader" : "Enable screen reader"}
            >
